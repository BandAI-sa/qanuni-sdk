"""Prompt-backed atomic date extraction."""

from __future__ import annotations

from qanuni.models.common import ToolRuntimeConfig
from qanuni.models.legal import DateExtractionResult, LegalExtractionInput
from qanuni.tools.legal._base import LegalDocumentExtractionTool


class DateExtractionTool(LegalDocumentExtractionTool[DateExtractionResult]):
    """Extract legally relevant dates and deadlines from Arabic documents."""

    TOOL_ID = "legal.extract_dates"
    INPUT_MODEL = LegalExtractionInput
    OUTPUT_MODEL = DateExtractionResult
    PROMPT_FILE = "legal/extract_dates.yaml"
